...
class AsignacionNiIngenieroForm(ModelForm):
    ...
    def clean(self):
        ...
        if estado_asignacion == REQUIERE_VISITA:
            ...
            'Si aun hay personal en campo y requiere soporte remoto para atender la falla \
            por favor llamar a Julie Sandoval para Centro/Occidente (3003008309) o a Dolcey \
            Torres para Costa/Oriente (3008623682).' +'\n'+'\n'+ \
