...
asignaciones_npo_asignada_un_dia = AsignacionNpo.objects.filter(estado_asignacion=ASIGNADA, fecha_asignacion__lte=TODAY)
asignaciones_npo_en_monitoreo_tres_dias = AsignacionNpo.objects.filter(estado_asignacion=EN_MONITOREO, actualizado__lte=THREEDAYS)
...
asignaciones_ni_asignada_un_dia  = AsignacionNi.objects.filter(estado_asignacion=ASIGNADA, fecha_asignacion__lte=TODAY)
asignaciones_ni_en_monitoreo_tres_dias= AsignacionNi.objects.filter(estado_asignacion=EN_MONITOREO, actualizado__lte=THREEDAYS)
