...
asignaciones_npo_asignada_un_dia = AsignacionNpo.objects.filter(estado_asignacion=ASIGNADA, fecha_asignacion__lte=YESTERDAY)
...
asignaciones_ni_asignada_un_dia  = AsignacionNi.objects.filter(estado_asignacion=ASIGNADA, fecha_asignacion__lte=YESTERDAY)
