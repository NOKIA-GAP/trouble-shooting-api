...
class Actividad(models.Model):
    wp = models.BigIntegerField(blank=True, null=True, editable=False, unique=True)#campo no editable
    id_notificacion_noc = models.IntegerField(blank=True, null=True)
    agrupador = models.CharField(max_length=255, blank=True, null=True, editable=False)#campo no editable
    service_supplier = models.CharField(max_length=255, blank=True, choices=choices.SERVICE_SUPPLIER_CHOICES, null=True, editable=False)#campo no editable
    estacion = models.ForeignKey(Estacion, on_delete=models.CASCADE,  blank=True, null=True, related_name='actividades', editable=False)#campo no editable
    banda = models.CharField(max_length=255, blank=True, null=True, editable=False)#campo no editable
    valor_wp_eur = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True, editable=False)#campo no editable
    proyecto = models.CharField(max_length=255, blank=True, null=True, editable=False)#campo no editable
    escenario = models.CharField(max_length=255, blank=True, null=True, editable=False)#campo no editable
